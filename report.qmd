...
model1 <- linear_reg() |>
  set_engine("lm") |>
  fit(Rates ~ Drug, data = NC_longer_18_25)

  predict(model1, data.frame(drugs, Drug = "Marijuana"))
  ...
  predict(model2, data.frame(drugs, Drug = "Tobacco"))
...
model3 <- linear_reg() |>
  set_engine("lm") |>
  fit(Rates ~ Drug, data = CO_longer_18_25)

  predict(model3, data.frame(drugs, Drug = "Marijuana"))
...
model4 <- linear_reg() |>
  ...
  predict(model4, data.frame(drugs, Drug = "Tobacco"))
...
>>>>>>> fc44927f0901d34e0bf73f29d997801b5b911971
