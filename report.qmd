...
TO DO - hypothesis test with regression models - expand on context - methodology- explain methods and what variables using (rate_tob is all tobacco, use 2012 as cut off, prob cite site where we saw hypothesis test), also nc? - include vaping thing into context - results- everything - marijuana usage today? prediction - is research question good?
...
CO_filter <- CO |>
  select(c("Year", "rate_mar_18_25", "rate_tob_cig_mon_18_25")) |>
  rename("Marijuana" = "rate_mar_18_25") |>
  rename("Tobacco" = "rate_tob_cig_mon_18_25")
