...
TO DO
- hypothesis test with regression models
- expand on context
- methodology- explain methods and what variables using (rate_tob is all tobacco, use 2012 as cut off, prob cite site where we saw hypothesis test), also nc?
- include vaping thing into context
- results- everything
- marijuana usage today? prediction
- is research question good?
...
TOBACCO PRE-2012
$tobacco = 0.000497 -0.00000740 * Year$

TOBACCO POST-2012
$tobacco = 0.000397 -0.0000267 * Year$

MARIJUANA PRE-2012
$marijuana = 0.000193 -0.00000900 * Year$

MARIJUANA POST-2012
$marijuana = 0.000310 -0.00000572 * Year$
